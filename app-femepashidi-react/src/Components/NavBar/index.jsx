...
import { Navbar, NavbarBrand, Nav, NavItem, NavLink ,Dropdown,DropdownToggle,DropdownMenu,DropdownItem, Modal, ModalHeader, ModalBody, ModalFooter, Form, FormGroup, Label, Input, Button} from 'reactstrap';
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const { data } = await axios.patch(
                `${server}api/v1/auth/me/password`,
...
export default function NavBar() {
  ...
  const togglePasswordModal = () => setPasswordModalOpen(prevState => !prevState);
